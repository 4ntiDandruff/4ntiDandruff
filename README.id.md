...
- Hijrah ke Linux (**Kubuntu 26.04**) dan ngerasa ribet pas mau ekstrak file arsip di jendela dialog import → Saya bikin background service **Auto-Extract Downloads**.
